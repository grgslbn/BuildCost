...
export const ANIM_CARDS: AnimCard[] = [
  { title: 'Villa', id: 'RB-2026-0847', date: '19·05·2026', file: 'plan-villa-ixelles.pdf',
    rows: [
      { label: 'Livable area', value: '186.4 m²' },
      { label: 'Finishing', value: { cls: 'fb-comfort', label: 'Comfort' } },
      { label: 'Coefficient', value: '× 1.12' },
      { label: 'Base · 1050 Ixelles', value: '€ 1 680/m²' },
      { label: 'ABEX 2026/I', value: '× 1.0000' },
    ],
    total: ['Rebuild cost', '€ 350 720'], footer: ['rebuilt.be', '12 rooms · 2 floors'] },
  { title: 'Apartment', id: 'RB-2026-0831', date: '18·05·2026', file: 'plan-apt-gent.pdf',
    rows: [
      { label: 'Livable area', value: '124.8 m²' },
      { label: 'Finishing', value: { cls: 'fb-luxury', label: 'Luxury' } },
      { label: 'Coefficient', value: '× 1.28' },
      { label: 'Base · 9000 Gent', value: '€ 1 520/m²' },
    ],
    total: ['Rebuild cost', '€ 242 810'], footer: ['rebuilt.be', '8 rooms · 1 floor'] },
  { title: 'Terraced', id: 'RB-2026-0819', date: '17·05·2026', file: 'plan-rijwoning-liege.pdf',
    rows: [
      { label: 'Livable area', value: '98.2 m²' },
      { label: 'Finishing', value: { cls: 'fb-standard', label: 'Standard' } },
      { label: 'Coefficient', value: '× 0.94' },
      { label: 'Base · 4000 Liège', value: '€ 1 440/m²' },
    ],
