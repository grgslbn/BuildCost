...
- **⚠ The unit-only factor is NOT a constant 1.35 — it spans ~1.12…1.35 with the circulation share.** Blind test "Hendrik I Lei" (corner block, 2 compact cores serving 5-6 apts/level): printed unit nets 401/level ×**1.12** = 449 = expert 448 exactly — ×1.3 overshot cat1 +18% (total +27%). Schaarbeek 23-499974 (10 small units, high circulation share) genuinely needed ×1.35. Heuristic: compact cores / few large units → low end (~1.12); many small units / long corridors → high end (~1.35). Better than a constant: estimate circulation from the plan (cores × footprint × levels) or output a band. Expert there also priced low (€1,848/m², F≈0.86) — F band for standard apartments is wider than 0.95–1.0.
