...
- **`cat1_basis` is NET vs GROSS** (not unit-vs-room): `net` = any "Netto Vloeropp." / NO figure incl. per-unit netto (×1.12); `gross` = BO/bruto (×1.0); `mixed` (×1.06). Validated: 23-499974 per-unit "APP.0.1 Netto Vloeropp 67,3" → net → 1106×1.12=1239.
